...
**Ví dụ 1:** Có 5 người, chọn 3 người và xếp vào 3 vị trí: Lớp trưởng, Lớp phó, Thư ký. Hỏi có bao nhiêu cách?
...
**Ví dụ 2:** Có bao nhiêu số có 4 chữ số khác nhau được tạo từ 1, 2, 3, 4, 5, 6?
...
**Bài 1:** Một lớp có 30 học sinh. Giáo viên muốn chọn 3 học sinh làm lớp trưởng, lớp phó, thủ quỹ. Hỏi có bao nhiêu cách chọn?
...
**Ký hiệu:** C(n, r) hoặc $\binom{n}{r}$ (đọc là "n chọn r")
...
| Thuật ngữ | Ký hiệu | Công thức | Chọn bao nhiêu? | Thứ tự | Ví dụ |
|-----------|---------|-----------|-----------------|---------|-------|
| **Hoán vị** | P(n) | n! | TẤT CẢ n | Có | Xếp 5 người vào 5 ghế |
| **Chỉnh hợp** | A(n,r) | n!/(n-r)! | r từ n | Có | Chọn 3 người từ 5 vào 3 vị trí |
| **Tổ hợp** | C(n,r) | n!/(r!(n-r)!) | r từ n | Không | Chọn 3 người từ 5 (nhóm) |
...
**Ví dụ 1:** Từ 5 học sinh, chọn 3 học sinh vào đội thi. Hỏi có bao nhiêu cách chọn?
...
**Bài 1:** Một lớp có 30 học sinh. Chọn 5 học sinh để tham gia hoạt động ngoại khóa (không phân biệt vai trò). Hỏi có bao nhiêu cách chọn?
...
**Bài 2:** Trong một đề thi có 10 câu, sinh viên phải chọn 6 câu để làm. Hỏi có bao nhiêu cách chọn?
...
| Chọn r từ n, **CÓ VỊ TRÍ** | A(n,r) = n!/(n-r)! | Chọn 3 người từ 5 vào 3 vị trí khác nhau |
| Chọn r từ n, **KHÔNG VỊ TRÍ** | C(n,r) = n!/(r!(n-r)!) | Chọn 3 người từ 5 thành nhóm |
...
**Câu 2:** Có bao nhiêu cách chọn 3 học sinh làm **Lớp trưởng, Lớp phó, Thư ký**?
- **Chỉnh hợp**: A(5, 3) = 60
- Giải thích: A làm LT ≠ A làm LP

**Câu 3:** Có bao nhiêu cách chọn 3 học sinh vào **đội thi**?
- **Tổ hợp**: C(5, 3) = 10
- Giải thích: Chọn A,B,C = Chọn C,B,A

```r
# So sánh kết quả
factorial(5)      # Hoán vị: 120
chinh_hop(5, 3)   # Chỉnh hợp: 60
choose(5, 3)      # Tổ hợp: 10
```
...
**Ví dụ 4:** Một lớp có 30 sinh viên, trong đó có 12 nữ. Chọn ngẫu nhiên 5 sinh viên. Tính xác suất có đúng 3 sinh viên nữ.
...
Một câu lạc bộ có 20 thành viên, trong đó có 8 nữ. Cần chọn 1 đội bóng chuyền gồm 6 người, trong đó phải có ít nhất 2 nữ. Hỏi có bao nhiêu cách chọn?
...
Một lớp có 24 học sinh. Giáo viên muốn chia thành 3 nhóm: Nhóm A (8 người), Nhóm B (8 người), Nhóm C (8 người). Hỏi có bao nhiêu cách chia?
...
2. Có bao nhiêu cách chọn 3 học sinh từ 15 học sinh vào đội thi (không phân biệt vai trò)?
3. Có bao nhiêu cách chọn 3 học sinh từ 15 học sinh để làm Lớp trưởng, Lớp phó, Thư ký?
...
2. Một hộp có 10 viên bi, trong đó 6 viên đỏ và 4 viên xanh. Lấy ngẫu nhiên 3 viên. Tính xác suất:
   - Cả 3 viên đều đỏ
   - Có đúng 2 viên đỏ
   - Có ít nhất 1 viên đỏ

3. Một lớp có 25 sinh viên, trong đó 10 nữ. Chọn ngẫu nhiên 4 sinh viên. Tính xác suất:
   - Cả 4 đều là nữ
   - Có đúng 2 nữ
   - Có ít nhất 1 nữ
